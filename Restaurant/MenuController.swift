...
class MenuController {
    ...
    static let menuUpdateNotification = Notification.Name("MenuController.menuDataUpdated")
    ...
    private func process(_ items: [MenuItem]) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: MenuController.menuUpdateNotification, object: nil)
        }
    }
